CREATE TABLE [Census].[Finance_2013] (
    ...
    CONSTRAINT [PK_Finance.2013] PRIMARY KEY CLUSTERED ([ID_Code] ASC, [Item_Code] ASC, [Year_of_Data] ASC)
);


GO
CREATE NONCLUSTERED INDEX [NCI_Census_Finance_2013]
    ON [Census].[Finance_2013]([Year_of_Data] ASC, [State] ASC);
